...
function MobileNav() {
   ...
   return (
      <nav className={`flex flex-col bg-white py-4 px-2 text-black w-full gap-4 fixed z-10 border-b border-b-black ${!icon ? 'bg-white h-[100%] overflow-hidden border-b-0' : ''} ${scroll ? 'shadow-lg shadow-gray-300' : ''}`}>
